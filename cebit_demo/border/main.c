...
/**
 * @brief       The pseudo border router is implemented by custom shell commands
 */
const shell_command_t border_shell[] = {
    {"fw", "Forward traffic [DST] [TYPE] [DATA]", portal_in},
    {NULL, NULL, NULL}
};
...
int main(void)
{
    ...
    // run the shell
    shell_init(&shell, border_shell, UART0_BUFSIZE, shell_readc, shell_putchar);
    shell_run(&shell);
    return 0;
}
